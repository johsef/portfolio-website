  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex-col">
          ...
          <div className="flex items-center mt-auto gap-2">
            {socialLinks.map(({ href, icon }, key) => (
              <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-slate-50/5 rounded-lg transition-[background-color,color] hover:bg-slate-50 hover:text-slate-950 active:bg-slate-50/80 reveal-up">
                {icon}
              </a>
            ))}
          </div>
        ...
        <form action="https://formsubmit.co/a6d2fb0a599865f61c67909d15c0c130" className="xl:pl-10 2xl:pl-20" method="POST">
